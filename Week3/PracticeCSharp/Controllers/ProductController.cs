...
namespace PracticeCSharp.Controllers
{
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Color,Size,Price,Description,CategoryId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Color,Size,Price,Description,CategoryId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
